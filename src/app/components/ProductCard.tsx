...
<div className="product-card max-w-md bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <a href={href} className="bg-white flex items-center justify-center p-4 rounded-t-lg">
